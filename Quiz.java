                ...
                do {
                    ...
                    switch (option6) {
                        ...
                        case "2": {
                            ...
                            if (numLines % 5 == 1) {
                                System.out.println("Enter the four options for question number " + Integer.toString(numLines / 5 + 1));
                                for (int cn = 1; cn <= 4; cn++) {
                                    String answerChoices ;
                                    if (cn == 1) {
                                        System.out.println("Enter the first choice");
                                ...
                                System.out.println("Enter the question and four options for question number " + Integer.toString(numLines / 5 + 1));
                                System.out.println("Enter the question statement");
                                String qs = sc.nextLine();
                                ...
                                System.out.println("Enter the options for question number " + Integer.toString(numLines / 5 + 1));
                        ...
                        case "3": {
                            ...
                            if (!s.contains(str1)) {
                                ...
                                for (int i = 0; i < l.length(); i++) {
                                    if (l.charAt(i) == 'A' || l.charAt(i) == 'B' || l.charAt(i) == 'C' || l.charAt(i) == 'D') {
                                        c++;
                                    }
                                    if (c == dqn) {
                                        if (i == l.length() - 2) {
