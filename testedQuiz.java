...
/**
 * testedQuiz class to enable testing to happen on
 * all methods of Quiz.java, please note that for testing purposes
 * this class(not Quiz.java) should be run with testingQuiz.java
...
public class testedQuiz {
    private int quizNumber;
    private int numOfQuestions;

    public testedQuiz(int quizNumber, String quizListFileName, int numOfQuestions,
    ...
    public testedQuiz(int quizNumber) {
        this.quizNumber = quizNumber;
    }
    ...
    public void makeQuizManual(String quizFileName,
                               String type, String input) throws IOException {
        File f2 = new File(quizFileName);
        f2.createNewFile();
