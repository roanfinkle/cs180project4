...
/**
 * testedStudent class to be tested with various inputs
 * by the testingStudent.java class. Please note: this
 * testedStudent.java class should be run with
 * the testingStudent.java file (Student.java should not
 * be run with the testingStudent.java class). Also, please read
 * comments in the testingStudent.java file as they contain important
 * details regarding how to run the tests as well what
 * all is covered by the test.
...
public class testedStudent {
    public void takeQuiz(String studentName, String teacherName,
                         ...
                         String quizIdentifier, String input) throws IOException {
